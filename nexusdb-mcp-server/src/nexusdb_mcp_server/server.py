...
Expone conectores de bases de datos como herramientas utilizables por
cualquier cliente compatible con MCP (Claude Desktop, Claude Code, Cursor,
Windsurf, etc.).

Por seguridad, las consultas ejecutadas a través de este servidor están
restringidas a operaciones de solo lectura (SELECT/SHOW/DESCRIBE/EXPLAIN).
"""
